...
function TranslationPage() {
  ...
  const renderText = () => {
    if (!translatedText) return null; // Add this check
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      if (data.translation) {
        ...
        setHighlightedText(''); // Clear any existing highlights
        setTempModifiedRanges([]); // Clear any existing modifications
      } else {
...
>
  {isEditing ? (
    ...
    renderText() || '' // Add fallback empty string
  )}
  <FloatingToolbar />
</div>
